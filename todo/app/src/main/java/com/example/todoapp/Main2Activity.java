...
public class Main2Activity extends AppCompatActivity {
    ...
    com.example.todoapp.NoScrollListView taskListToday, taskListTomorrow, taskListUpcoming;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mydb = new com.example.todoapp.DBHelper(this);
    ...
    public void openAddModifyTask(View view) {
        startActivity(new Intent(this, com.example.todoapp.AddModifyTask.class));
    }
    ...
    public void loadListView(com.example.todoapp.NoScrollListView listView, final ArrayList<HashMap<String, String>> dataList) {
        ListTaskAdapter adapter = new ListTaskAdapter(this, dataList, mydb);
        listView.setAdapter(adapter);
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view,
                                    int position, long id) {
                Intent i = new Intent(Main2Activity.this, com.example.todoapp.AddModifyTask.class);
